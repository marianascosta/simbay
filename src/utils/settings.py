...
WARP_LIKELIHOOD_TEMPERATURE = max(_read_float("SIMBAY_WARP_LIKELIHOOD_TEMPERATURE", 100.0), 1e-6)
...
try:
    WARP_RESAMPLE_WARMUP_STEPS = max(int(os.getenv("SIMBAY_WARP_RESAMPLE_WARMUP_STEPS", "200")), 0)
except ValueError:
    WARP_RESAMPLE_WARMUP_STEPS = 200
